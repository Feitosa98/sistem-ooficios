...
Consulte [Correções, validação e ativação](./MELHORIAS-E-VALIDACAO.md) para os acessos, migrações, configuração de certificados e melhorias pendentes.
...
- `db/schema.ts` contains the application tables and access/signature records
